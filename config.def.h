...
static const char col_cyan[]        = "#bd93f9"; /* "#005577"; /* selected background & border */
...
static const char *dmenucmd[]   = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-h", "29", "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, NULL };
